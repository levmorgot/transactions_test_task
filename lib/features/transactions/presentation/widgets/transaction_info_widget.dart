  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        ..._buildInfoField('Дата транзакции:', '${transaction.date.day}.${transaction.date.month}.${transaction.date.year}'),
        ..._buildInfoField('Сумма:', '${transaction.amount.toStringAsFixed(2)} руб.'),
